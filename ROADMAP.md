...
| 3    | 语音管线联动：voiceMap.ts + VoiceCommandService 关键词注入改造 + TTS voiceId / STT language 接线                     | 英文模式下英文关键词可控制 FSM，英文 voice 播报          | 代码完成：voiceMap 枢纽 + KEYWORD_MAPS 按语言 dispatch + STT/TTS 接线，四连全过；待真机验收 |
