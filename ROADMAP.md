...
- **无障碍第五轮：详情页** (2026-09-05，门禁全绿)：hero 返回按钮 label、份数 stepper 符号按钮 label、备料食材卡 checkbox 角色 + checked/disabled 语义；Button 组件新增 accessibilityLabel 透传。全屏覆盖收官，accessibilityLabel 为 0 的待办销项
